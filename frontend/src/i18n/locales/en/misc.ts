  ...
  payment: {
    ...
    admin: {
      tabs: {
        ...
        channels: 'Channels',
        plans: 'Plans',
        orderManagement: 'Order management views',
        userAdjustments: 'Manual Adjustments',
      },
      ...
      adjustments: {
        filters: {
          keyword: 'Search',
          keywordPlaceholder: 'User ID, email, or name',
          operator: 'Operator',
          operatorPlaceholder: 'Operator email or ID',
          kind: 'Resource',
          operation: 'Operation',
          direction: 'Direction',
        ...
        summary: {
          recordCount: 'Records',
          balanceIncrease: 'Balance added',
          balanceDecrease: 'Balance deducted',
          balanceNet: 'Balance net',
          concurrencyIncrease: 'Concurrency added',
          concurrencyDecrease: 'Concurrency removed',
          concurrencyNet: 'Concurrency net',
        },
        columns: {
          time: 'Time',
          target: 'User',
        ...
        detail: {
          ...
          clientIp: 'Client IP',
          legacyRedeemCodeId: 'Legacy record ID',
        },
        sources: {
          admin: 'Administrator action',
          adminBalance: 'Balance adjustment',
          adminUserUpdate: 'User edit',
          adminBatchConcurrency: 'Batch concurrency adjustment',
          adminBatchLimits: 'Batch limit update',
          legacy: 'Legacy redeem record',
        },
        authMethods: {
          jwt: 'Admin session',
        ...
        unknown: 'Unknown',
        legacyOperator: 'Legacy record (operator unknown)',
        noNotes: 'No notes',
        empty: 'No manual adjustments found',
        exportCsv: 'Export CSV',
        exporting: 'Exporting...',
        exportSuccess: 'Adjustment records exported',
        errors: {
          invalidTimeRange: 'Start time must not be later than end time.',
          loadFailed: 'Failed to load adjustment records',
          exportFailed: 'Failed to export adjustment records',
        },
      },
      subsStatus: {
        active: 'Active',
