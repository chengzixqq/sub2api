export default {
    ...
    customization: {
      ...
      accountHint: '留空表示继承全局设置；账号级配置优先于全局设置。',
      inherit: '沿用全局',
