  ...
  payment: {
    ...
    admin: {
      tabs: {
        ...
        channels: '支付渠道',
        plans: '订阅套餐',
        orderManagement: '订单管理视图',
        userAdjustments: '人工调整',
      },
      todayRevenue: '今日收入',
      totalRevenue: '总收入',
      todayOrders: '今日订单',
      ...
      adjustments: {
        filters: {
          keyword: '搜索',
          keywordPlaceholder: '用户 ID、邮箱或名称',
          operator: '操作员',
          operatorPlaceholder: '操作员邮箱或 ID',
          kind: '资源类型',
          operation: '操作类型',
          direction: '变更方向',
          startTime: '开始时间',
        ...
        summary: {
          ...
          balanceNet: '余额净变化',
          concurrencyIncrease: '并发增加',
          concurrencyDecrease: '并发扣减',
          concurrencyNet: '并发净变化',
        },
        columns: {
          time: '时间',
          target: '目标用户',
        ...
        detail: {
          ...
          requestId: '请求 ID',
          clientIp: '客户端 IP',
          legacyRedeemCodeId: '历史记录 ID',
        },
        sources: {
          admin: '管理员操作',
          adminBalance: '余额调整',
          adminUserUpdate: '编辑用户',
          adminBatchConcurrency: '批量调整并发',
          adminBatchLimits: '批量更新限制',
          legacy: '历史兑换记录',
        },
        authMethods: {
          jwt: '管理员会话',
        ...
        unknown: '未知',
        legacyOperator: '历史记录（操作员未知）',
        noNotes: '无备注',
        empty: '暂无人工调整记录',
        exportCsv: '导出 CSV',
        exporting: '正在导出...',
        exportSuccess: '人工调整流水已导出',
        errors: {
          invalidTimeRange: '开始时间不能晚于结束时间',
          loadFailed: '加载人工调整流水失败',
          exportFailed: '导出人工调整流水失败',
        },
      },
      subsStatus: {
        active: '生效中',
