...
func TestAdminService_UpdateGroup_ClearsReasoningPolicyForUnsupportedPlatform(t *testing.T) {
	...
	_, err := svc.UpdateGroup(WithScope(context.Background(), AdminScope()), existing.ID, &UpdateGroupInput{Platform: PlatformGemini})
...
func TestAdminService_UpdateGroup_CodexModelsManifestConfigUntouchedWhenOmitted(t *testing.T) {
	...
	_, err := svc.UpdateGroup(WithScope(context.Background(), AdminScope()), existing.ID, &UpdateGroupInput{Name: "renamed"})
