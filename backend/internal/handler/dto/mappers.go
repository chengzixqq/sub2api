...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	return UsageLog{
		...
		ProbeCoalesced:            l.ProbeCoalesced,
		ProbeLeaderRequestID:      l.ProbeLeaderRequestID,
		ProviderCostRecorded:      l.ProviderCostRecorded,
...
func UsageCleanupTaskFromService(task *service.UsageCleanupTask) *UsageCleanupTask {
	...
	return &UsageCleanupTask{
		...
		Filters: UsageCleanupFilters{
			NativeCompactionV2:    task.Filters.NativeCompactionV2,
			UpstreamModelMismatch: task.Filters.UpstreamModelMismatch,
			BillingMode:           task.Filters.BillingMode,
			EndExclusive:          task.Filters.EndExclusive,
